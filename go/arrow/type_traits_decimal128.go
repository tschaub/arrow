...
func (decimal128Traits) CastFromBytes(b []byte) []decimal128.Num {
	...
	return unsafe.Slice((*decimal128.Num)(unsafe.Pointer(h.Data)), len(b)/Decimal128SizeBytes)
}
...
func (decimal128Traits) CastToBytes(b []decimal128.Num) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Decimal128SizeBytes)
}
