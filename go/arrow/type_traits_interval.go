...
func (monthTraits) CastFromBytes(b []byte) []MonthInterval {
	...
	return unsafe.Slice((*MonthInterval)(unsafe.Pointer(h.Data)), len(b)/MonthIntervalSizeBytes)
}
...
func (monthTraits) CastToBytes(b []MonthInterval) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*MonthIntervalSizeBytes)
}
...
func (daytimeTraits) CastFromBytes(b []byte) []DayTimeInterval {
	...
	return unsafe.Slice((*DayTimeInterval)(unsafe.Pointer(h.Data)), len(b)/DayTimeIntervalSizeBytes)
}
...
func (daytimeTraits) CastToBytes(b []DayTimeInterval) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*DayTimeIntervalSizeBytes)
}
...
func (monthDayNanoTraits) CastFromBytes(b []byte) []MonthDayNanoInterval {
	...
	return unsafe.Slice((*MonthDayNanoInterval)(unsafe.Pointer(h.Data)), len(b)/MonthDayNanoIntervalSizeBytes)
}
...
func (monthDayNanoTraits) CastToBytes(b []MonthDayNanoInterval) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*MonthDayNanoIntervalSizeBytes)
}
