...
func (int64Traits) CastFromBytes(b []byte) []int64 {
	...
	return unsafe.Slice((*int64)(unsafe.Pointer(h.Data)), len(b)/Int64SizeBytes)
}
...
func (int64Traits) CastToBytes(b []int64) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Int64SizeBytes)
}
...
func (uint64Traits) CastToBytes(b []uint64) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Uint64SizeBytes)
}
...
func (float64Traits) CastFromBytes(b []byte) []float64 {
	...
	return unsafe.Slice((*float64)(unsafe.Pointer(h.Data)), len(b)/Float64SizeBytes)
}
...
func (float64Traits) CastToBytes(b []float64) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Float64SizeBytes)
}
...
func (int32Traits) CastToBytes(b []int32) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Int32SizeBytes)
}
...
func (uint32Traits) CastFromBytes(b []byte) []uint32 {
	...
	return unsafe.Slice((*uint32)(unsafe.Pointer(h.Data)), len(b)/Uint32SizeBytes)
}
...
func (uint32Traits) CastToBytes(b []uint32) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Uint32SizeBytes)
}
...
func (float32Traits) CastFromBytes(b []byte) []float32 {
	...
	return unsafe.Slice((*float32)(unsafe.Pointer(h.Data)), len(b)/Float32SizeBytes)
}
...
func (float32Traits) CastToBytes(b []float32) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Float32SizeBytes)
}
...
func (int16Traits) CastFromBytes(b []byte) []int16 {
	...
	return unsafe.Slice((*int16)(unsafe.Pointer(h.Data)), len(b)/Int16SizeBytes)
}
...
func (int16Traits) CastToBytes(b []int16) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Int16SizeBytes)
}
...
func (uint16Traits) CastFromBytes(b []byte) []uint16 {
	...
	return unsafe.Slice((*uint16)(unsafe.Pointer(h.Data)), len(b)/Uint16SizeBytes)
}
...
func (uint16Traits) CastToBytes(b []uint16) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Uint16SizeBytes)
}
...
func (int8Traits) CastFromBytes(b []byte) []int8 {
	...
	return unsafe.Slice((*int8)(unsafe.Pointer(h.Data)), len(b)/Int8SizeBytes)
}
...
func (int8Traits) CastToBytes(b []int8) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Int8SizeBytes)
}
...
func (uint8Traits) CastFromBytes(b []byte) []uint8 {
	...
	return unsafe.Slice((*uint8)(unsafe.Pointer(h.Data)), len(b)/Uint8SizeBytes)
}
...
func (uint8Traits) CastToBytes(b []uint8) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Uint8SizeBytes)
}
...
func (timestampTraits) CastFromBytes(b []byte) []Timestamp {
	...
	return unsafe.Slice((*Timestamp)(unsafe.Pointer(h.Data)), len(b)/TimestampSizeBytes)
}
...
func (timestampTraits) CastToBytes(b []Timestamp) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*TimestampSizeBytes)
}
...
func (time32Traits) CastFromBytes(b []byte) []Time32 {
	...
	return unsafe.Slice((*Time32)(unsafe.Pointer(h.Data)), len(b)/Time32SizeBytes)
}
...
func (time32Traits) CastToBytes(b []Time32) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Time32SizeBytes)
}
...
func (time64Traits) CastFromBytes(b []byte) []Time64 {
	...
	return unsafe.Slice((*Time64)(unsafe.Pointer(h.Data)), len(b)/Time64SizeBytes)
}
...
func (time64Traits) CastToBytes(b []Time64) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Time64SizeBytes)
}
...
func (date32Traits) CastFromBytes(b []byte) []Date32 {
	...
	return unsafe.Slice((*Date32)(unsafe.Pointer(h.Data)), len(b)/Date32SizeBytes)
}
...
func (date32Traits) CastToBytes(b []Date32) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Date32SizeBytes)
}
...
func (date64Traits) CastFromBytes(b []byte) []Date64 {
	...
	return unsafe.Slice((*Date64)(unsafe.Pointer(h.Data)), len(b)/Date64SizeBytes)
}
...
func (date64Traits) CastToBytes(b []Date64) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Date64SizeBytes)
}
...
func (durationTraits) CastFromBytes(b []byte) []Duration {
	...
	return unsafe.Slice((*Duration)(unsafe.Pointer(h.Data)), len(b)/DurationSizeBytes)
}
...
func (durationTraits) CastToBytes(b []Duration) []byte {
	...
	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*DurationSizeBytes)
}
