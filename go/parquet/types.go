...
func (int96Traits) CastFromBytes(b []byte) []Int96 {
	...
	return unsafe.Slice((*Int96)(unsafe.Pointer(h.Data)), len(b)/Int96SizeBytes)
}

func (int96Traits) CastToBytes(b []Int96) []byte {
	h := (*reflect.SliceHeader)(unsafe.Pointer(&b))

	return unsafe.Slice((*byte)(unsafe.Pointer(h.Data)), len(b)*Int96SizeBytes)
}
...
func (byteArrayTraits) CastFromBytes(b []byte) []ByteArray {
	...
	return unsafe.Slice((*ByteArray)(unsafe.Pointer(h.Data)), len(b)/ByteArraySizeBytes)
}
...
func (fixedLenByteArrayTraits) CastFromBytes(b []byte) []FixedLenByteArray {
	...
	return unsafe.Slice((*FixedLenByteArray)(unsafe.Pointer(h.Data)), len(b)/FixedLenByteArraySizeBytes)
}
